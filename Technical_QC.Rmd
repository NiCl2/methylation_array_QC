...
**Arrays ran by:** `r print(SampleSheet[1,"Name_lab"])`, The University of Exeter Medical School
...
RGset_controls <- RGset[,which(RGset@colData@listData$Basename %in% meth_controls)]
par(mfrow=c(1,1))
...
times<-SampleSheet[which(SampleSheet$Basename %in% meth_controls), c("Date_array_run", "Date_Bisulphite_con")]
